...
plugin.init = function(params, callback) {
	...
	router.get('/admin/plugins/dida-forum', hostMiddleware.admin.buildHeader, controllers.renderAdminPage);
	router.get('/api/admin/plugins/dida-forum', controllers.renderAdminPage);
